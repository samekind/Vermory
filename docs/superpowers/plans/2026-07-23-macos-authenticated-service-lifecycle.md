# macOS Authenticated Service Lifecycle Plan

- [x] Freeze the I11 lifecycle, storage, security, and non-claim boundary.
- [x] Add failing installer and rollback contract tests.
- [x] Add candidate compatibility preflight and protected rollback slot.
