# W37 Real Repository Corpus Plan

- [x] Run the current trusted workspace probe against roots and nested directories in six heterogeneous public repositories.
- [x] Freeze exact source revisions, expected isolation, hard failures, and non-claims in the W37 case.
- [x] Add deterministic manifest validation and an opt-in real-checkout acceptance test.
