...
2. Extend the accepted client topology beyond the exact cases already run.
   ...
   `32 / 32`. The paid `grok-build` route remains outside the qualified
   boundary, as do arbitrary repositories and long-duration network behavior.
